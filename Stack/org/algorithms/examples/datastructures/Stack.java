...
public class Stack {
	...
	/**
	 * Remove the top item from the stack, and return it. Throws an
	 * IllegalStateException if the stack is empty when this method is called.
	 */
	public int pop() {
		if (top == null)
	...
	private static void sortedInsert(Stack s, int x) {
